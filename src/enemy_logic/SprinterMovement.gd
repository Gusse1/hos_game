...
func set_movement_target():
	navigation_agent.set_target_position(shared_variables.player_body.global_position)
...
func _physics_process(delta):
	...
	if enemy_state.ACTIVE and not start:
		...
		if shared_variables.player_body.global_position.distance_to(navigation_agent.get_parent().global_position) < enemy_state.ATTACK_RANGE:
